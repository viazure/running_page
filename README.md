...
Known indoor activities (treadmill, indoor, VirtualRun, and GPS that barely moves)
still get a stored route from the previous outdoor activity. A run that only lacks
GPS stays unchanged unless `REUSE_ROUTE_FOR_MISSING_GPS=1`.
